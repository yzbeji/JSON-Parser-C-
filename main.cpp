...
int main()
{
    ...
    argument arg0(R"(max(glossary.GlossDiv.GlossList.GlossEntry.GlossDef.GlossSeeAlso[0], 3, glossary.GlossDiv.GlossList.GlossEntry.GlossDef.GlossSeeAlso[1]))");   
    ...
    argument arg2(R"(glossary.GlossDiv.GlossList.GlossEntry.GlossDef.GlossSeeAlso[7], glossary, glossary.GlossDiv.title)");  
